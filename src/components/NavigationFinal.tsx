      ...
      <Container>
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          >
            ...
            <span className="text-lg md:text-xl font-bold text-text-primary hidden sm:inline">
              6ixminds Labs
            </span>
          </button>
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            {navItems.map((item) => (
              <motion.button
                ...
                className="text-text-primary hover:text-brand-purple transition-colors font-medium text-body-md min-h-tap px-2"
            ...
            <motion.button
              ...
              className="bg-brand-purple text-white px-6 py-3 rounded-lg font-semibold hover:bg-brand-pink transition-all shadow-lg shadow-purple-500/20 text-body-sm min-h-tap"
              whileHover={
                shouldReduceMotion
                  ? {}
